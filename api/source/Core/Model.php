...
abstract class Model
{
    ...
    {
        if (!$this->required()) {
            $this->message->setText("Preencha todos os campos para continuar");
            return false;
        }
        ...
        if (!empty($this->id)) {
            ...
            if ($this->fail()) {
                $this->message->setText("Erro ao atualizar, tente novamente!");
                return false;
            }
        }
        ...
        if (empty($this->id)) {
            ...
            if ($this->fail()) {
                $this->message->setText("Erro ao cadastrar, tente novamente!");
                return false;
            }
        }
